...
config_path = Path('service/cfg/yolov3.cfg')
# файл весов сети YOLO
weights_path = Path('service/weights/yolov3.weights')
# файл всех меток классов (объектов)
labels_path = Path('service/data/coco.names')
# файл изображения
image_path = Path('service/images/morj_2.jpg')
...
def render_image(idxs: cv2, image: cv2, boxes, confidences, class_ids) -> None:
    ...
    new_image_path = f'service/recognized/{filename}_yolov3{ext}'
